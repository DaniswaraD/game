...
- Service-worker cache is versioned as v57-light.

# Danis.Shooter v57 — Responsive UI & Full QA Build

v57 keeps the existing gameplay systems intact while applying the unified responsive UI system and a full package QA pass.
