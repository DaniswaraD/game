(function(){
  ...
  var registry={
    ...
    pixi:{url:'https://cdn.jsdelivr.net/npm/pixi.js@8.21.0/dist/pixi.min.js',test:function(){return !!window.PIXI}}
  };
  var promises={};
  function load(name){
  ...
  window.DS_LIBS={
    versions:{gsap:'3.15.0',howler:'2.2.4',pixi:'8.21.0'},
    load:load,
    loadGsap:function(){return load('gsap');},
    loadHowler:function(){return load('howler');},
    loadPixi:function(){return load('pixi');},
  ...
  // Pixi is deliberately lazy: it is only requested when gameplay actually starts.
